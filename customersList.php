      ...
      <section id="content">
        ...
        <div class="container">
          <div class="section">
            ...
            <p class="caption">List of all Customers</p>
		...
		echo "<div class='col s12 m6 l4'>
                                <div id='profile-card' class='card'>
                                    ...
                                    <div class='card-content'>
                                        ...
                                        <span class='card-title activator grey-text text-darken-4'> ".$row['CUSTOMER_NAME']."</span>
                                        <p><i class='mdi-action-perm-identity cyan-text text-darken-2'></i> ".$row['CUSTOMER_TYPE']."</p>
                                    ...
                                    <div class='card-reveal'>
                                        ...
                                        <p>Here is some more information about ".$row['CUSTOMER_NAME'].".</p>
                                        <p><i class='mdi-action-perm-identity cyan-text text-darken-2'></i> ".$row['CUSTOMER_TYPE']."</p>
                                        <p><i class='mdi-action-perm-phone-msg cyan-text text-darken-2'></i> ".$row['CUSTOMER_PHONE']."</p>
                                        <p><i class='mdi-communication-email cyan-text text-darken-2'></i> ".$row['CUSTOMER_EMAIL']."</p>
										...
										<a class='btn-floating waves-effect waves-light light-blue' href='customerDetails.php?customer_id=".$row['CUSTOMER_ID']."'><i class='mdi-action-info activator'></i></a>
									</div>
                                </div>
                            </div>";
}
