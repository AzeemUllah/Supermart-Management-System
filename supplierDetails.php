...
if ($result->num_rows > 0) {
	...
	echo "<p class='caption'>Details of Supplier: ".$row['SUPPLIER_NAME']."</p>
		...
		echo "<div id='profile-page-header' class='card'>
                ...
                <div class='card-content'>
                  <div class='row'>                    
                    <div class='col s3 offset-s2'>                        
                        <h4 class='card-title grey-text text-darken-4'>".$row['SUPPLIER_NAME']."</h4>
                        <p class='medium-small grey-text'> ".$row['SUPPLIER_TYPE']." Supplier</p>                        
                    </div>
                ...
                <div class='card-reveal'>
                    <p>
                      ...
                      <span><i class='mdi-action-perm-identity cyan-text text-darken-2'></i> ".$row['SUPPLIER_TYPE']." Customer</span>
                    </p>
...
if ($result2->num_rows > 0) {
	...
	while($row2 = mysqli_fetch_array($result2))
	{
		...
		<li class='collection-item'>
                                        ...
                                        <div class='row'>
                                            <div class='col s7'>
                                                <p class='collections-title'><strong>Order # ".$row2['PURCHASE_ORDER_ID']."   </strong>".$row2['PURCHASE_TOTAL']." PKR</p>
                                                <p class='collections-content'>Ordered By: ".$row2['EMPLOYEE_NAME']."</p>
                                            </div>
                                            <div class='col s3'>
                                                <span class='task-cat pink accent-2'>".$row2['PURCHASE_TOTAL']."/10,000</span>
                                            </div>
                                            <div class='col s3'>
                                                <div class='progress'>
                                                     <div class='determinate' style='width: ".(($row2['PURCHASE_TOTAL'])/10000)*100 ."%'></div>   
                                                </div>                                                
                                            </div>
                                        </div>
				   </li>
  ...
  <!-- END FOOTER -->
	...
	function conformDelete($id) {
        	...
        	function(){
				...
				window.location.href = "api-supplierDelete.php?supplier_id=" + $id;
			});
...
$sql="SELECT *, (PURCHASE_TOTAL-PURCHASE_PAID) AS PURCHASE_DUE FROM purchase_order where SUPPLIER_ID=".$_GET['supplier_id'];
